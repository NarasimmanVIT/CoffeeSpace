  ...
  return (
    <section className="connect-section">
      ...
      <div className="connect-top">
        ...
        <p>
          CoffeeSpace brings us up together entrepreneurs who share similar business interests, <br /> industry focus, and collaborative goals. Find your ideal business partners through meaningful connections.
        </p>
